...
class PluginManager {
  ...
  async loadPlugins() {
    try {
        console.log("[❄Dark-Love-MD-V1❄ ] Loading plugins...");
        ...
        console.log("[❄Dark-Love-MD-V1❄] Plugins loaded successfully.");
    } catch (error) {
        console.error("[❄Dark-Love-MD-V1❄] Error loading plugins:", error);
    }
}
