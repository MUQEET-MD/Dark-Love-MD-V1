...
module.exports = [
...
},
 {
  ...
  operate: async ({ Kango, m, reply, prefix, command, text }) => {
    ...
    const profilePic = await Kango.profilePictureUrl(m.sender, "image").catch(() => "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.html?q=60");
