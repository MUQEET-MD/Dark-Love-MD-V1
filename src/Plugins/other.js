...
\n⏳ *Code expires in 2 minutes!*`);
  ...
  operate: async ({ m, Kango, reply }) => {
    try {
      const repoUrl = "https://github.com/ayodejibot/Dark-Love-MD";
      const zipUrl = `${repoUrl}/archive/refs/heads/main.zip`;

      // Fetch repo details to get avatar
      const { data: repo } = await axios.get("https://api.github.com/repos/ayodejibot/Dark-Love-MD");
      const { data: avatarBuffer } = await axios.get(repo.owner.avatar_url, {
        responseType: "arraybuffer"
      });

      const caption =
        `*Dark-Love-MD-V1 Repository*\n\n` +
        `🔗 *Repository URL*: ${repoUrl}\n` +
        `📂 *Branch*: main\n` +
        `📦 *File*: Dark-Love-MD-V1-main.zip\n\n` +
      ...
      await Kango.sendMessage(m.chat, {
        ...
        contextInfo: {
          externalAdReply: {
            title: "Dark-Love-MD-V1 GitHub Repo",
      ...
      await Kango.sendMessage(m.chat, {
        document: zipBuffer,
        fileName: "Dark-Love-MD-V1-main.zip",
...
┃ ━━━━━━━━━━━━━━━━━━━
┃ 🇬🇭 *Owner:* *Dark-Love-MD-V1*
┃ 💰 *Opay:* *9065645391*
┃ 💸 
┃ 🪙
┃ 🪀 *WhatsApp:* 2348122441244
╰━━━━━━━━━━━━━━━━━━━━⬣
...
💡 *If you have ideas or questions, feel free to reach out!* 💬`;
  ...
  operate: async ({
    ...
    try {
      ...
      const { data: repo } = await axios.get("https://api.github.com/repos/ayodejibot/Dark-Love-MD-V1");
